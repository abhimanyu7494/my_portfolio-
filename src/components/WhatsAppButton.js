...
const WhatsAppButton = () => {
    ...
    return (_jsx("a", { href: "https://wa.me/919661104667", target: "_blank", rel: "noopener noreferrer", style: styles.button, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, children: _jsx(SiWhatsapp, { style: styles.icon }) }));
};
